  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        <div className="flex justify-center mb-8">
          <div className="text-black text-2xl font-bold flex items-center">
            ...
            <div className="relative w-8 h-8 mx-1">
              ...
              <div className="absolute inset-0 border-t-2 border-black rounded-full transform rotate-45"></div>
              <div className="absolute inset-0 border-t-2 border-black rounded-full transform -rotate-45"></div>
            </div>
            <span>ipsum</span>
          </div>
        ...
        <p className="text-center text-gray-600 mb-8">selamat datang kembali! silakan masukkan rincian Anda</p>
        ...
        <div className="mt-6">
          <button className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
